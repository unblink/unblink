...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/unblink/unblink/relay/gen/unblink/chat/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	ChatServiceName = "unblink.chat.v1.ChatService"
)
...
const (
	...
	ChatServiceCreateConversationProcedure = "/unblink.chat.v1.ChatService/CreateConversation"
	// ChatServiceListConversationsProcedure is the fully-qualified name of the ChatService's
	// ListConversations RPC.
	ChatServiceListConversationsProcedure = "/unblink.chat.v1.ChatService/ListConversations"
	// ChatServiceGetConversationProcedure is the fully-qualified name of the ChatService's
	// GetConversation RPC.
	ChatServiceGetConversationProcedure = "/unblink.chat.v1.ChatService/GetConversation"
	// ChatServiceUpdateConversationProcedure is the fully-qualified name of the ChatService's
	// UpdateConversation RPC.
	ChatServiceUpdateConversationProcedure = "/unblink.chat.v1.ChatService/UpdateConversation"
	// ChatServiceDeleteConversationProcedure is the fully-qualified name of the ChatService's
	// DeleteConversation RPC.
	ChatServiceDeleteConversationProcedure = "/unblink.chat.v1.ChatService/DeleteConversation"
...
// ChatServiceClient is a client for the unblink.chat.v1.ChatService service.
...
// NewChatServiceClient constructs a client for the unblink.chat.v1.ChatService service. By default,
...
func NewChatServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ChatServiceClient {
	...
	chatServiceMethods := v1.File_unblink_chat_v1_chat_proto.Services().ByName("ChatService").Methods()
...
// CreateConversation calls unblink.chat.v1.ChatService.CreateConversation.
...
// ListConversations calls unblink.chat.v1.ChatService.ListConversations.
...
// GetConversation calls unblink.chat.v1.ChatService.GetConversation.
...
// UpdateConversation calls unblink.chat.v1.ChatService.UpdateConversation.
...
// DeleteConversation calls unblink.chat.v1.ChatService.DeleteConversation.
...
// ListMessages calls unblink.chat.v1.ChatService.ListMessages.
...
// ChatServiceHandler is an implementation of the unblink.chat.v1.ChatService service.
...
func NewChatServiceHandler(svc ChatServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/unblink.chat.v1.ChatService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedChatServiceHandler) CreateConversation(context.Context, *connect.Request[v1.CreateConversationRequest]) (*connect.Response[v1.CreateConversationResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("unblink.chat.v1.ChatService.CreateConversation is not implemented"))
}
...
func (UnimplementedChatServiceHandler) ListConversations(context.Context, *connect.Request[v1.ListConversationsRequest]) (*connect.Response[v1.ListConversationsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("unblink.chat.v1.ChatService.ListConversations is not implemented"))
}
...
func (UnimplementedChatServiceHandler) GetConversation(context.Context, *connect.Request[v1.GetConversationRequest]) (*connect.Response[v1.GetConversationResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("unblink.chat.v1.ChatService.GetConversation is not implemented"))
}
...
func (UnimplementedChatServiceHandler) UpdateConversation(context.Context, *connect.Request[v1.UpdateConversationRequest]) (*connect.Response[v1.UpdateConversationResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("unblink.chat.v1.ChatService.UpdateConversation is not implemented"))
}
...
func (UnimplementedChatServiceHandler) DeleteConversation(context.Context, *connect.Request[v1.DeleteConversationRequest]) (*connect.Response[v1.DeleteConversationResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("unblink.chat.v1.ChatService.DeleteConversation is not implemented"))
}
...
func (UnimplementedChatServiceHandler) SendMessage(context.Context, *connect.Request[v1.SendMessageRequest], *connect.ServerStream[v1.SendMessageResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("unblink.chat.v1.ChatService.SendMessage is not implemented"))
}
