          ...
          <Select.Content class="bg-neu-850 border border-neu-700 rounded-lg shadow-lg z-50 max-h-[300px] overflow-auto">
            <For each={collection().items}>
              {(item) => (
                <Select.Item
                  item={item}
                  class="flex items-center justify-between gap-3 px-3 py-2 cursor-pointer hover:bg-neu-800 transition-colors data-highlighted:bg-neu-800 text-neu-200 text-sm"
                >
